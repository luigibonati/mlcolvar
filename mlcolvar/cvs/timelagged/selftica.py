...
class SelfTICA(BaseCV):
    ...
    def training_step(self, train_batch, batch_idx):
        """
        Compute the training loss and update monitoring metrics.

        The current and lagged configurations are encoded, the contrastive
        loss is evaluated, and the TICA eigenvalues are computed without
